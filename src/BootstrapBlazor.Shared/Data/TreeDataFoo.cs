...
class TreeDataFoo
{
    ...
    public static List<TreeItem> GetTreeItems()
    {
        var items = new List<TreeItem>
        {
            ...
            new TreeItem() { Text = "孙菜单一", Id = "1070", ParentId = "1050", Icon = "fa fa-fa", CanDrag = false},
            new TreeItem() { Text = "孙菜单二", Id = "1080", ParentId = "1050", Icon = "fa fa-fa", CanDrag = false },
            new TreeItem() { Text = "孙菜单三", Id = "1090", ParentId = "1050", Icon = "fa fa-fa", CanDrag = false },
